...
type LoginUserResponse struct {
	...
	AccessTokenExpireAt  *timestamp.Timestamp `protobuf:"bytes,5,opt,name=access_token_expire_at,json=accessTokenExpireAt,proto3" json:"access_token_expire_at,omitempty"`
	RefreshTokenExpireAt *timestamp.Timestamp `protobuf:"bytes,6,opt,name=refresh_token_expire_at,json=refreshTokenExpireAt,proto3" json:"refresh_token_expire_at,omitempty"`
}
...
func (x *LoginUserResponse) GetAccessTokenExpireAt() *timestamp.Timestamp {
	if x != nil {
...
func (x *LoginUserResponse) GetRefreshTokenExpireAt() *timestamp.Timestamp {
	if x != nil {
...
var file_rpc_login_user_proto_rawDesc = []byte{
	...
	0x41, 0x74, 0x42, 0x05, 0x5a, 0x03, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
